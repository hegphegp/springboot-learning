# JPA-plus
##### 参考这篇博客 https://blog.csdn.net/u012706811/article/details/53218102 , 寻找官方是不已实现了这种模式, 不要重复制造质量劣质的不合格轮子
##### 参考这个github.com仓库 https://github.com/ActiveJpa/activejpa 的ActiveRecord实体类不通过JpaRepository怎么实现增删查改
##### 参考这个github.com仓库 https://github.com/ActiveJpa/activejpa 的ActiveRecord实体类不通过JpaRepository怎么实现增删查改
##### 参考这个github.com仓库 https://github.com/ActiveJpa/activejpa 的ActiveRecord实体类不通过JpaRepository怎么实现增删查改
```java
